...
module.exports = class {
  data() {
    return {
      ...
      permalink: '/prenota-una-call/',
      pageTitle: 'Prenota una call gratuita con Forge | Varese',
      pageDescription:
        'Scegli giorno e orario: 15 minuti, gratuiti e senza impegno. Parli direttamente con chi costruisce il software. Forge, software house a Varese.',
      eleventyNavigation: {
        key: 'prenota-una-call',
...
<section class="sec-paper" id="prenota">
  <div class="split-grid">
    ...
    <div
      ...
      data-booking-widget
      data-action="${data.form.url.contactUs()}"
      data-recaptcha="${data.form.recaptchaClientKey}"
      aria-label="Calendario prenotazione call gratuita"
    ></div>
  </div>
</section>
...
<section class="sec-dark">
  <div class="cta-band">
    <h2>Niente preventivi a freddo.</h2>
    <p>Solo 15 minuti per capire se possiamo aiutarti. La prima call è gratuita e senza impegno — uscirai con un parere concreto.</p>
    <a class="btn-primary" href="#prenota" aria-label="Torna al widget di prenotazione">prenota_call →</a>
  </div>
</section>`
  }
}
